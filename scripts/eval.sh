# ####################### fb15k-237 ######################################################
 CUDA_VISIBLE_DEVICES=0 python train_kgdm.py --cuda --dataset FB15K-237 --do_test \
...
# ####################### wn18rr ######################################################
 CUDA_VISIBLE_DEVICES=0 python train_kgdm.py --cuda --dataset wn18rr --do_test \
...
# ####################### umls ######################################################
 CUDA_VISIBLE_DEVICES=0 python train_kgdm.py --cuda --dataset umls --do_test  \
...
# # ####################### kinship ######################################################
 CUDA_VISIBLE_DEVICES=0 python train_kgdm.py --cuda --dataset kinship --do_test \
